//Obteniendo la informacion por medio del DOM
...
//Monstrar informacion de medicos
...
//Monstrar informacion de pacientes
...
if (window.location.href.endsWith("registro-medicos.html")) {
    //El evento para el formularioMedicos va a ser de tipo enviar o guardar es decir submit
...
if (window.location.href.endsWith("registro-pacientes.html")) {
    ...
    formularioPacientes.addEventListener("submit", function (event) {
        ...
        const paciente = new Usuario(valorNombres, valorApellidos, valorCedula, valorTelefono, valorEspecialidad)
        paciente.consultorio = valorEdad
